        ...
        $('#logload').css("display", "block");
            ...
            ajaxcall(url, method, data, function (response) {
                ...
                if (response.status == 1) {
                    ...
                    /*--------------If one race is active upload sponsor logo-----------------*/
                    var file = '';
                    var fileChooser = document.getElementById('file-chooser');  
                    if (fileChooser.value == '')
                    {
                        $('#file-chooser').css('border-bottom', '1px solid #ccc');
                        $("#statusMsg").html('<h5 style="color:red;">Please upload Sponsor Logo</h5>');       
                    }
                    else
                    {
                        $("#statusMsg").html('');    
                                    ...
                                    if (ssize <= 2097152) {
                                        ...
                                        if (file) {
                                            ...
                                            var params = {
                                                ...
                                                Key: response.eventId +'-'+sponsorName +'-sponsorlogo',
                                            ...
                                            s3.putObject(params, function (err, res) {
                                                if (err) {
                                                    ...
                                                    var url = baseURL+"uploadsponsorlogo";
                                                    var method = "POST";
                                                    var data = {
